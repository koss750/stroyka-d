							...
							<form class="needs-validation" novalidate="">
								...
								<div class="mb-3">
									...
									<div class="input-group">
										...
										<input type="text" class="form-control form-r-radius" id="username" placeholder="Username" required="">
								...
								<hr class="mb-4">
								<button class="btn btn-primary btn-lg d-block w-100" type="submit">Continue to
									checkout</button>
							</form>
						</div>
					</div>
