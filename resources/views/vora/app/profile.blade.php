			...
			<div class="card">
				<div class="card-body">
					...
					<div class="profile-blog mb-5">
						<h5 class="text-primary d-inline">Today Highlights</h5><a href="javascript:void(0);" class="pull-right f-s-16">More</a>
								...
								<div id="my-posts" class="tab-pane fade active show">
									<div class="my-post-content pt-3">
										<div class="post-input">
											<textarea name="textarea" id="textarea" cols="30" rows="7" class="form-control bg-transparent" placeholder="Please type what you want...."></textarea> 
