...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function processPayment() {
        ...
        function registerOrder() {
            ...
            const paymentAmount = {{ $price }}; // Assuming the payment amount is fixed at 200 rubles
